...
const immama = document.querySelector("#immama");
const shut = document.querySelector("#close");
...
const showimmama = document.querySelector('.immama');
...
mat.addEventListener("click", () => {
  showmat.classList.add('show');

})

immama.addEventListener("click", () => {
  showimmama.classList.add('show');
...
shut.addEventListener("click", () => {
  ...
  showmat.classList.remove('show');
  showimmama.classList.remove('show');
})
